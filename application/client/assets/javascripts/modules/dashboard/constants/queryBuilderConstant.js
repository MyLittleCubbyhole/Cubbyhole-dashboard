angular.module('Dashboard').
    constant('QUERY_BUILDER', {
        ...
        "user.birthdate.month": { "format":"number", "category":"user", "index": "user.birthdate.month", "type": "segment", "alias": "birthmonth", "formattedAlias": "Birth month", "datatype" : "number" },
        ...
        "user.inscriptiondate.month": { "format":"number", "category":"user", "index": "user.inscriptiondate.month", "type": "segment", "alias": "inscriptionmonth", "formattedAlias": "Inscription month", "datatype" : "number" },
        ...
        "payment.date.month": { "format":"number", "category":"payment", "index": "payment.date.month", "type": "segment", "alias": "payment_month", "formattedAlias": "Payment month", "datatype" : "number" },
        ...
        "dailyquota.date.month": { "format":"number", "category":"dailyquota", "index": "dailyquota.date.month", "type": "segment", "alias": "quota_month", "formattedAlias": "Quota month", "datatype" : "number" },
        ...
        "subscribe.datestart.month": { "format":"number", "category":"subscribe", "index": "subscribe.datestart.month", "type": "segment", "alias": "subscribe_datestart_month", "formattedAlias": "Subscribe start month", "datatype" : "number" },
        ...
        "subscribe.dateend.month": { "format":"number", "category":"subscribe", "index": "subscribe.dateend.month", "type": "segment", "alias": "subscribe_dateend_month", "formattedAlias": "Subscribe end month", "datatype" : "number" },
